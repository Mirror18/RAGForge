...
const profileForm = ref({ providerConnectionId: "", purpose: "CHAT", modelName: "mimo-v2.5", capabilities: "CHAT,USAGE_REPORTING", contextWindow: 32768, maxOutputTokens: 2048, embeddingDimension: null as number | null, usageReporting: "PROVIDER_REPORTED", status: "PUBLISHED" });
