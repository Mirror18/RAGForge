...
<template>
  <main class="shell">
    ...
    <ControlCenterView v-else-if="session && spaces.length > 0 && view === 'control'" role="tabpanel" aria-labelledby="control-center-tab" :selected-space-id="selectedSpaceId" :current-role="currentRole" :current-user-id="session.user.userId" :initial-section="controlSection" />
