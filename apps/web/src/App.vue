...
.workspace-context { display: grid; grid-template-columns: minmax(220px, 1.25fr) .55fr .45fr minmax(180px, 1fr) auto; align-items: end; gap: 18px; margin-bottom: 30px; padding: 13px 16px; border: 1px solid #e4e9f1; border-radius: 14px; background: #fff; box-shadow: 0 8px 24px #28466c08; }.space-switcher { min-width: 0; }.space-switcher select { height: 38px; margin-top: 4px; border-color: #d6e0ec; background: #fbfcfe; font-size: .8rem; font-weight: 700; }.context-stat { min-width: 0; padding-left: 18px; border-left: 1px solid #edf0f4; }.context-stat strong { display: block; margin-top: 5px; color: #30486d; font-size: .78rem; }.context-id { min-width: 0; padding-left: 18px; border-left: 1px solid #edf0f4; }.context-id code { display: block; max-width: 100%; margin-top: 5px; overflow: hidden; color: #6a7890; font-family: "Cascadia Code", Consolas, monospace; font-size: .66rem; text-overflow: ellipsis; white-space: nowrap; }.context-profile { padding: 9px 12px; font-size: .72rem; white-space: nowrap; }
