...
<style scoped>
.web-source-card { margin-top: 15px; padding: 18px; }.web-source-card h3 { margin: 5px 0 0; color: #284572; }.web-source-card .muted { margin: 6px 0 0; font-size: .78rem; }.web-source-form { display: flex; align-items: end; flex-wrap: wrap; gap: 12px; margin-top: 15px; }.web-source-form .field { flex: 1 1 360px; }.check-row { display: flex; align-items: center; gap: 7px; color: #526b92; font-size: .78rem; }.check-row input { accent-color: #315b97; }
