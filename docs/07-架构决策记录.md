...
ADR 的 Accepted 只表示决策已被接受，不表示对应功能已经实现；实施状态、任务卡、测试和风险仍以 `docs/08–32` 与 Git history 为准。

## 收录源文件

- `adr/README.md`
- `adr/0001-modular-monolith-and-worker.md`
- `adr/0002-java-ai-version-baseline.md`
- `adr/0003-postgresql-qdrant-and-messaging.md`
- `adr/0004-space-level-rbac.md`
- `adr/0005-provider-abstraction-and-egress.md`
- `adr/0006-versioned-ingestion-and-indexes.md`
- `adr/0007-session-authentication.md`
- `adr/0008-evaluation-and-llm-observability.md`
- `adr/0009-upstream-reuse-policy.md`
- `adr/0010-phase5-provider-material-composition.md`
- `adr/0011-multi-instance-run-event-fanout.md`
- `adr/0012-durable-bm25.md`
- `adr/0013-versioned-knowledge-execution.md`
...
## 原始文档：`adr/0001-modular-monolith-and-worker.md`
...
## 原始文档：`adr/0002-java-ai-version-baseline.md`
...
## 原始文档：`adr/0003-postgresql-qdrant-and-messaging.md`
...
## 原始文档：`adr/0004-space-level-rbac.md`
...
## 原始文档：`adr/0005-provider-abstraction-and-egress.md`
...
## 原始文档：`adr/0006-versioned-ingestion-and-indexes.md`
...
## 原始文档：`adr/0007-session-authentication.md`
...
## 原始文档：`adr/0008-evaluation-and-llm-observability.md`
...
## 原始文档：`adr/0009-upstream-reuse-policy.md`
...
## 原始文档：`adr/0010-phase5-provider-material-composition.md`
...
- [Phase 5 Retrospective](./31-阶段5复盘.md)

---

## 原始文档：`adr/0011-multi-instance-run-event-fanout.md`
...
- [`API_AND_EVENTS.md`](./02-项目架构与领域模型.md)
...
- [检索与问答架构](./02-项目架构与领域模型.md)
- DurableBm25CandidateStore、QdrantIndexWriter 与重启测试证据

---

## 原始文档：`adr/0013-versioned-knowledge-execution.md`
...
精确命名、不变量、失败模型、迁移顺序和验收矩阵统一定义于[演进总设计](./02-项目架构与领域模型.md)，各架构文档只保留提案入口，避免复制多份规则。
