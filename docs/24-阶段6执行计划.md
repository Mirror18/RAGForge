...
|---|---|---|---|---|---|---|
| P6-A | 冻结 checklist、计划、证据 schema、风险入口 | `docs/04-交付路线与质量门禁.md` 的 Phase 6 章节、`docs/24-阶段6执行计划.md`、Phase 6 contract/evidence schema | Phase 5 records、RAG evaluation、performance/security docs | 主 Agent | Markdown/link/schema checks | runtime feature |
...
| P6-H | full gates, records, risk/traceability/retrospective/CI closure | `docs/10-项目状态审计记录.md`、`docs/11-风险登记表.md`、`docs/12-需求追溯矩阵.md`、retrospective | all P6 evidence and merged commits | 主 Agent | full local + GitHub Actions | new runtime behavior |
