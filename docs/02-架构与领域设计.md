...
- `docs/02-architecture/INGESTION_PIPELINE.md`
- `docs/02-architecture/PROVIDER_AND_RUN_MODEL.md`
- `docs/02-architecture/RETRIEVAL_AND_CHAT.md`
- `docs/02-architecture/API_AND_EVENTS.md`
- `docs/02-architecture/ARCHITECTURE_EVOLUTION.md`

---

## 原始文档：`docs/02-architecture/ARCHITECTURE.md`
...
## 原始文档：`docs/02-architecture/DOMAIN_MODEL.md`
...
## 原始文档：`docs/02-architecture/INGESTION_PIPELINE.md`
...
## 原始文档：`docs/02-architecture/PROVIDER_AND_RUN_MODEL.md`
...
## 原始文档：`docs/02-architecture/RETRIEVAL_AND_CHAT.md`
...
## 原始文档：`docs/02-architecture/API_AND_EVENTS.md`
...
## 原始文档：`docs/02-architecture/ARCHITECTURE_EVOLUTION.md`
