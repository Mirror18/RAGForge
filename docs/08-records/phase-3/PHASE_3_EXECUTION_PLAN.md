...
| P3-E | file/local-directory/Git read-only connector 和 canonical path | `backend/ingestion-worker` connector 包、connector unit/acceptance tests | P3-B、P3-C | Connector Agent | full/incremental add/modify/move/delete/unchanged、duplicate basename、Git SHA、Windows/Linux | parser依赖、Web connector |
