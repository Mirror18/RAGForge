...
- `R-028` 已关闭（本提交范围）：本地 Syft/跟踪内容 Grype 已通过，最新 GitHub Actions quality [`32575757466`](https://github.com/Mirror18/RAGForge/actions/runs/32575757466) 全绿；阶段 SBOM artifact `9476272419`、Grype SARIF artifact `9476280585` 可追溯。发布前仍需按目标镜像/digest 重跑发布级扫描。
