...
- `R-010` 继续 MITIGATING：PDFBox 2.0.30、POI 5.4.0、MinIO SDK 8.6.0、OkHttp JVM 5.1.0 已记录于 [`DEPENDENCY_AND_LICENSE_EVIDENCE.md`](phase-3/DEPENDENCY_AND_LICENSE_EVIDENCE.md)；Run [31677079831](https://github.com/Mirror18/RAGForge/actions/runs/31677079831) 的 Syft/Grype 通过，正式发布仍必须复核传递依赖许可证。
