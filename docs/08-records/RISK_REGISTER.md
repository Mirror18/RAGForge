...
- `R-028` 已关闭（本提交范围）：本地 Syft/跟踪内容 Grype 已通过，最新 GitHub Actions quality [`32577294291`](https://github.com/Mirror18/RAGForge/actions/runs/32577294291) 全绿；阶段 SBOM artifact `9476872865`、Grype SARIF artifact `9476881768` 可追溯。发布前仍需按目标镜像/digest 重跑发布级扫描。
