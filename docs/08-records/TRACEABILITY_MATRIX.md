...
| P7-WEB-001 | 首次设置与成员协作 | `SpaceService.updateMember` 支持 membership upsert；`PersonalSpaceView.vue` 只遍历已有成员并提供改角色/移除 | API 部分存在，Web 用户旅程未实现 | ACTIVE 用户选择/搜索、加入空间、Editor/Viewer 首次进入与权限 E2E |
