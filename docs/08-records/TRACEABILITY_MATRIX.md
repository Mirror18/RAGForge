...
| P6-REC-001 | 隔离恢复 RPO/RTO 与故障场景覆盖 | [`phase6-recovery.v1.json`](../../tests/evidence/phase6-recovery.v1.json)、[`BACKUP_RESTORE.md`](../../docs/05-operations/BACKUP_RESTORE.md) | 完整/PG/Qdrant/object/index/tombstone/outbox 场景通过；RPO `0s`、RTO `12.416s`；5/5 unit | 周期性演练和生产 digest/备份策略 |
