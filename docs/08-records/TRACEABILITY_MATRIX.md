...
| P6-SEC-001 | 空间、证据、出境、工具、解析和提示注入安全 | [`phase6-security.v1.json`](../../tests/evidence/phase6-security.v1.json)、[`security_evaluation.py`](../../scripts/phase6/security_evaluation.py)、[quality run 32574857389](https://github.com/Mirror18/RAGForge/actions/runs/32574857389) | 23/23；cross-space/Evidence 外引用/unauthorized cloud/SSRF/工具越权/解析绕过均 0；Syft/Grype CI 通过，SBOM `9476272419`、SARIF `9476280585` | 后续人工 red-team |
