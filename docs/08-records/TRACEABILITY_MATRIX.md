...
| P6-SEC-001 | 空间、证据、出境、工具、解析和提示注入安全 | [`phase6-security.v1.json`](../../tests/evidence/phase6-security.v1.json)、[`security_evaluation.py`](../../scripts/phase6/security_evaluation.py)、[quality run 32575757466](https://github.com/Mirror18/RAGForge/actions/runs/32575757466) | 23/23；cross-space/Evidence 外引用/unauthorized cloud/SSRF/工具越权/解析绕过均 0；Syft/Grype CI 通过，阶段 SBOM `9476272419`、SARIF `9476280585` 可追溯 | 后续人工 red-team |
