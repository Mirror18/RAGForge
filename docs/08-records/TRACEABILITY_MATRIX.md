...
| P6-PERF-001 | 真实 embedding 维度和 1M mixed retrieval | [`phase6-capacity-retrieval.v1.json`](../../tests/evidence/phase6-capacity-retrieval.v1.json)、[`PHASE_6_CAPACITY_RUNBOOK.md`](../../docs/04-quality/PHASE_6_CAPACITY_RUNBOOK.md) | Ollama dimension 768 已实测；1M 写入 WinError 10060，未取得有效 p95/Recall；smoke 不作替代 | 隔离 Qdrant/批量写入稳定性修复后重跑 |
