...
| P6-SEC-001 | 空间、证据、出境、工具、解析和提示注入安全 | [`phase6-security.v1.json`](../../tests/evidence/phase6-security.v1.json)、[`security_evaluation.py`](../../scripts/phase6/security_evaluation.py)、[quality run 32570689145](https://github.com/Mirror18/RAGForge/actions/runs/32570689145) | 23/23；cross-space/Evidence 外引用/unauthorized cloud/SSRF/工具越权/解析绕过均 0；Syft/Grype CI 通过，SBOM `9475233814`、SARIF `9475239975` | 后续人工 red-team |
...
| P6-OPS-001 | retention、audit export、cost aggregation、SSE cleanup | [`Phase6OperationsService.java`](../../apps/server/src/main/java/com/ragforge/server/ops/Phase6OperationsService.java)、[`PHASE_6_RETENTION_AUDIT_COST.md`](../../docs/05-operations/PHASE_6_RETENTION_AUDIT_COST.md)、`Phase6OperationsServiceTest` | 默认关闭、按 space/time scope、payload 仅 hash；定向 4/4 | 真实受控运行演练与多实例 live fan-out |
| P6-PERF-001 | 真实 embedding 维度和 1M mixed retrieval | [`phase6-capacity-retrieval-a2.v1.json`](../../tests/evidence/phase6-capacity-retrieval-a2.v1.json)、[`PHASE_6_CAPACITY_RUNBOOK.md`](../../docs/04-quality/PHASE_6_CAPACITY_RUNBOOK.md) | Ollama dimension 768；1,000,000 points、4-space filter、20 concurrency、Recall@10 `0.995`、p95 `119.8761ms`、error rate `0`；向量值明确为 live dimension 下公共合成值 | 生产 embedding 语义质量/成本仍需独立评估 |
| P6-ONLINE-001 | non-AI API p95 与 SSE first event p95 | [`phase6-capacity-online.v1.json`](../../tests/evidence/phase6-capacity-online.v1.json)、[`online_latency_probe.py`](../../scripts/phase6/online_latency_probe.py) | server 未提供、SSE 无认证 run URL，证据 `FAILED/BLOCKED` | 提供隔离 server 和 authenticated harness 后重跑 |
