...
>
> 上一次更新：2026-08-30 | 更新人：Orchestrator | 对应基线 SHA：f015a25
...
- **主线基线 SHA（main）**：`f015a25`；`origin/main`：`9fdd94e0e12afae1c3843d0680fb48017e00669f`
...
| P7Q-05 | RAG 变更强制评估触发脚本 | P1 | 🚧 in_progress | A14 | codex/p7-rag-eval-gate-a14 | RAGForge-worktrees/codex-p7-rag-eval-gate-a14 | 5,000 | — | — | 已建立 ticket；检测 retrieval/answer/prompt/chunk/embedding/rerank/parser 变更并强制 128-case 离线评估 |
