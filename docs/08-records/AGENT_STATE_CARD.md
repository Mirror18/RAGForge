...
>
> 上一次更新：2026-08-30 | 更新人：Orchestrator | 对应基线 SHA：4ec57ce
...
- **主线基线 SHA（main）**：`4ec57ce`；`origin/main`：`9fdd94e0e12afae1c3843d0680fb48017e00669f`
...
| P7C-04 | durable BM25 ADR + 实现（R-023） | P0 | 🚧 in_progress | A2 | codex/p7-durable-bm25-a2 | RAGForge-worktrees/codex-p7-durable-bm25-a2 | 10,000 | — | — | 用户已明确批准接受 ADR-0012；执行 durable lexical 重建/存储，禁止自行新增生产迁移 |
