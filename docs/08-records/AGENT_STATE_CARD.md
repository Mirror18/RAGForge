...
| P7Q-04 | 契约-实现一致性门禁 | P1 | 🚧 in_progress | A12 | codex/p7-contract-coverage-a12 | RAGForge-worktrees/codex-p7-contract-coverage-a12 | 4,000 | — | — | 已建立 Ticket；校验 OpenAPI operationId 与 Controller 暴露端点双向覆盖，并接入 CI |
