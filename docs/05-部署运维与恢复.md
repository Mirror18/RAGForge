...
部署验收不能由文档文字代替。Linux 干净环境、运行时观测、升级回滚等结果必须在 `08-records/` 和 `tests/evidence/` 留下可复核证据。

## 收录源文件

- `docs/05-operations/DEPLOYMENT.md`
- `docs/05-operations/OBSERVABILITY.md`
- `docs/05-operations/observability-profile.md`
- `docs/05-operations/BACKUP_RESTORE.md`
- `docs/05-operations/PHASE_6_RETENTION_AUDIT_COST.md`
- `docs/05-operations/runbooks/README.md`
- `docs/05-operations/runbooks/provider-outage.md`
- `docs/05-operations/runbooks/ingestion-backlog.md`
- `docs/05-operations/runbooks/unauthorized-egress.md`
- `docs/05-operations/runbooks/database-capacity.md`

---

## 原始文档：`docs/05-operations/DEPLOYMENT.md`
...
## 原始文档：`docs/05-operations/OBSERVABILITY.md`
...
## 原始文档：`docs/05-operations/observability-profile.md`
...
## 原始文档：`docs/05-operations/BACKUP_RESTORE.md`
...
## 原始文档：`docs/05-operations/PHASE_6_RETENTION_AUDIT_COST.md`
...
## 原始文档：`docs/05-operations/runbooks/README.md`
...
## 原始文档：`docs/05-operations/runbooks/provider-outage.md`
...
## 原始文档：`docs/05-operations/runbooks/ingestion-backlog.md`
...
## 原始文档：`docs/05-operations/runbooks/unauthorized-egress.md`
...
## 原始文档：`docs/05-operations/runbooks/database-capacity.md`
