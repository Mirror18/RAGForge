...
- `docs/00-governance/START_HERE.md`
- `docs/00-governance/PROJECT_MANUAL.md`
- `README.md`

---

## 原始文档：`docs/00-governance/START_HERE.md`
...
| 安全与合规 | [安全基线](./06-安全合规与研究.md) → [风险登记表](./08-records/RISK_REGISTER.md) |
...
## 原始文档：`docs/00-governance/PROJECT_MANUAL.md`
...
1. [状态卡](./08-records/AGENT_STATE_CARD.md)
2. [任务板](./08-records/TASK_BOARD.md)
3. 对应的 [Worker Ticket](./08-records/tickets/)
...
- [部署与运行](./05-部署运维与恢复.md)
- [安全基线](./06-安全合规与研究.md)
- [风险登记表](./08-records/RISK_REGISTER.md)
- [当前项目状态](./08-records/PROJECT_STATUS.md)
...
根目录 [`AGENTS.md`](../AGENTS.md) 是硬规则真源；[任务板](./08-records/TASK_BOARD.md) 是任务与预算真源；[状态卡](./08-records/AGENT_STATE_CARD.md) 是日常运行快照；`PROJECT_STATUS.md` 只在审计、阶段闭环和发布治理时作为证据级记录。不要提交凭据、个人 Obsidian 内容、生产数据、raw prompt、构建产物或未经批准的第三方源码。
