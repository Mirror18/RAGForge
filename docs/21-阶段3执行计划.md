...
|---|---|---|---|---|---|---|
| P3-A | checklist、验收口径、执行记录 | `docs/04-交付路线与质量门禁.md` 的 Phase 3 章节、`docs/21-阶段3执行计划.md` | Phase 3 PRD/ADR/安全/质量文档 | 主 Agent | checklist 未勾选、量化门槛明确、所有权表提交 | 任何运行时代码 |
...
| P3-H | 阶段记录、风险、追溯、retrospective、push和闭环 | `docs/10-项目状态审计记录.md`、`docs/11-风险登记表.md`、`docs/12-需求追溯矩阵.md`、retrospective | 全部证据 | 主 Agent | checklist全勾、main全量通过、GitHub Actions成功、worktree clean | 新功能实现 |
