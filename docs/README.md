...
| `03-delivery` | Phase、研发流程、完成定义 | [路线图](03-delivery/ROADMAP.md) / [Phase 0 清单](03-delivery/PHASE_0_CHECKLIST.md) / [多 Agent Loop](03-delivery/MULTI_AGENT_LOOP_PROMPT.md) |
...
文档状态约定：规划文档描述当前基线；ADR 保存不可变决策历史；records 保存有日期的执行证据。代码开始后，每个 Phase 的退出条件必须引用实际 CI、评估、性能、安全或恢复报告。
