...
- P6-SEC-01/02/03/04：[`phase6-security.v1.json`](../../tests/evidence/phase6-security.v1.json)、[quality run 32574857389](https://github.com/Mirror18/RAGForge/actions/runs/32574857389)；23/23 安全回归通过，Syft/Grype CI 通过，当前 SBOM artifact `9476272419`、Grype SARIF `9476280585` 已生成。
