...
- P6-SEC-01/02/03/04：[`phase6-security.v1.json`](../../tests/evidence/phase6-security.v1.json)、[quality run 32571964923](https://github.com/Mirror18/RAGForge/actions/runs/32571964923)；23/23 安全回归通过，Syft/Grype CI 通过，SBOM artifact `9475538975`、Grype SARIF `9475547194` 已生成。
...
- P6-OBS-02：[`phase6-capacity-online.v1.json`](../../tests/evidence/phase6-capacity-online.v1.json)；server 未运行且 SSE 无认证 run URL，证据为 `FAILED/BLOCKED`，未满足阈值。
