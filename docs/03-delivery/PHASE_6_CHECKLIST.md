...
- P6-SEC-01/02/03/04：[`phase6-security.v1.json`](../../tests/evidence/phase6-security.v1.json)、[quality run 32577615540](https://github.com/Mirror18/RAGForge/actions/runs/32577615540)；23/23 安全回归通过，Syft/Grype CI 通过，阶段 SBOM artifact `9476947757`、Grype SARIF `9476956953` 可追溯。
