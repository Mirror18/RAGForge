...
- P6-SEC-01/02/03/04：[`phase6-security.v1.json`](../../tests/evidence/phase6-security.v1.json)、[quality run 32577294291](https://github.com/Mirror18/RAGForge/actions/runs/32577294291)；23/23 安全回归通过，Syft/Grype CI 通过，阶段 SBOM artifact `9476872865`、Grype SARIF `9476881768` 可追溯。
...
- 真实流式指标补充：[`phase6-real-ollama-stream-metrics.v1.json`](../../tests/evidence/phase6-real-ollama-stream-metrics.v1.json)、[`ollama_stream_metrics.py`](../../scripts/phase6/ollama_stream_metrics.py)；loopback `LOCAL_ONLY` standalone probe 测得 TTFT `9130.6742ms`、provider total `11456.3744ms`、wall `11475.2584ms`、`19.6176 tokens/s`、usage `35/46/81`，只保存 prompt/output hash/长度，不保存原文；不替代同步 RAG graph 集成 TTFT 或并发成本。
