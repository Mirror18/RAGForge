...
CONTROLLER_PATHS = (
    "backend/server/src/main/java/com/ragforge/server/answer/AnswerFeedbackController.java",
    "backend/server/src/main/java/com/ragforge/server/answer/api/AnswerApiController.java",
    "backend/server/src/main/java/com/ragforge/server/identity/AuthController.java",
    "backend/server/src/main/java/com/ragforge/server/identity/PlatformAdminBootstrapController.java",
    "backend/server/src/main/java/com/ragforge/server/identity/UserAdminController.java",
    "backend/server/src/main/java/com/ragforge/server/index/BusinessIndexController.java",
    "backend/server/src/main/java/com/ragforge/server/ingestion/BusinessIngestionController.java",
    "backend/server/src/main/java/com/ragforge/server/ops/ManagementController.java",
    "backend/server/src/main/java/com/ragforge/server/prompt/PromptManagementController.java",
    "backend/server/src/main/java/com/ragforge/server/provider/ModelProfileController.java",
    "backend/server/src/main/java/com/ragforge/server/provider/ModelRouteController.java",
    "backend/server/src/main/java/com/ragforge/server/provider/ProviderConnectionController.java",
    "backend/server/src/main/java/com/ragforge/server/provider/SpaceBindingController.java",
    "backend/server/src/main/java/com/ragforge/server/run/RunEventController.java",
    "backend/server/src/main/java/com/ragforge/server/run/RunExecutionController.java",
    "backend/server/src/main/java/com/ragforge/server/space/SpaceController.java",
    "backend/server/src/main/java/com/ragforge/server/studio/ChunkStudioController.java",
    "backend/server/src/main/java/com/ragforge/server/studio/RetrievalPlaygroundController.java",
)
